...
provinces = {1:"Vinnytsia", 13 : "Mykolaiv", 2:"Volyn", 14:"Odesa", 3:"Dnipropetrovsk", 15:"Poltava",
    4:"Donetsk", 16:"Rivne", 5:"Zhytomyr", 17:'Sumy', 6:"Zakarpattia", 18:"Ternopil", 7:"Zaporizhzhia", 19:"Kharkiv",
    8:"Ivano-Frankivsk", 20:"Kherson", 9:"Kyiv", 21:"Khmelnytskyi", 10:"Kirovohrad", 22:"Cherkasy", 11:"Lyhansk", 23:"Chernivtsi",
    12:"Lviv", 24:"Chernihiv", 25:"Autonomous Respublic of Crimea" }
...
def choose_province():
    print("Hey, choose province and years you need: (E.g. 21 2017 2018) ")
...
def main():
    ...
    df = vhi_file("11_Mean_2017-2018_2018_12_06_21_53_13_647267.txt")
    print(df.head(40))
    print(df.VHI.min())
    print(df.VHI.max())
